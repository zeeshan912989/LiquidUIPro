...
import { ShoppingBag, Search, Menu, X, ArrowRight, Star, Instagram, Twitter, Facebook } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1 md:col-span-1 lg:col-span-1">
              ...
              <div className="flex gap-4">
                <Instagram className="h-5 w-5 cursor-pointer hover:text-[#C9A96E] transition-colors" />
                <Twitter className="h-5 w-5 cursor-pointer hover:text-[#C9A96E] transition-colors" />
                <Facebook className="h-5 w-5 cursor-pointer hover:text-[#C9A96E] transition-colors" />
              </div>
            </div>
